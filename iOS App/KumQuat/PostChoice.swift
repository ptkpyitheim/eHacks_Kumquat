...
//        dbHandler.createPost(author: authorId!, content: "test123", dorm: "test123", college: "test123", locationShared: false, isAnon: true, timestamp: Int(NSDate().timeIntervalSince1970), parent_post: -1)
//        self.navigationController?.popViewController(animated: true)
